...
GO
PRINT N'Dropping unnamed constraint on [dbo].[Booking]...';


GO
ALTER TABLE [dbo].[Booking] DROP CONSTRAINT [DF__Booking__checked__34C8D9D1];
...
GO
ALTER TABLE [dbo].[Booking] DROP COLUMN [checkedIn];


GO
PRINT N'Creating [dbo].[spBookings_GetBooking]...';
...
END
GO
PRINT N'Creating [dbo].[spBookings_getGuest]...';
...
END
GO
PRINT N'Creating [dbo].[spBookings_getHomestay]...';
...
END
GO
PRINT N'Creating [dbo].[spBookings_GetHomestayType]...';
