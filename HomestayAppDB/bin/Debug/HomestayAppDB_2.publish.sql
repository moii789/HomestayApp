...
IF EXISTS (select top 1 1 from [dbo].[Homestays])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT
...
GO
ALTER TABLE [dbo].[Booking] ALTER COLUMN [arrivalDate] DATE NOT NULL;

ALTER TABLE [dbo].[Booking] ALTER COLUMN [departureDate] DATE NOT NULL;


GO
PRINT N'Altering [dbo].[Homestays]...';
